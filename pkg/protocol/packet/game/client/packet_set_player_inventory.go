...
// SetPlayerInventoryContentsTemp is a sub-structure used in the packet.
type SetPlayerInventoryContentsTemp struct {
	// Mapper to string
	Type string
	// Switch 基於 Type：
...
func (p *SetPlayerInventoryContentsTemp) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
func (p SetPlayerInventoryContentsTemp) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// SetPlayerInventoryContentsRemoveComponentsEntry is a sub-structure used in the packet.
type SetPlayerInventoryContentsRemoveComponentsEntry struct {
	// Mapper to string
	Type string
}

// ReadFrom reads the data from the reader.
func (p *SetPlayerInventoryContentsRemoveComponentsEntry) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
// WriteTo writes the data to the writer.
func (p SetPlayerInventoryContentsRemoveComponentsEntry) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// SetPlayerInventoryContents is a sub-structure used in the packet.
type SetPlayerInventoryContents struct {
	ItemCount             int32 `mc:"VarInt"`
	ItemId                int32 `mc:"VarInt"`
	AddedComponentCount   int32 `mc:"VarInt"`
	RemovedComponentCount int32 `mc:"VarInt"`
	Components            []SetPlayerInventoryContentsTemp
	RemoveComponents      []SetPlayerInventoryContentsRemoveComponentsEntry
}

// ReadFrom reads the data from the reader.
func (p *SetPlayerInventoryContents) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
	...
	if p.ItemCount != 0 {
		...
		p.Components = make([]SetPlayerInventoryContentsTemp, componentsCount)
	...
	if p.ItemCount != 0 {
		...
		p.RemoveComponents = make([]SetPlayerInventoryContentsRemoveComponentsEntry, removeComponentsCount)
...
// WriteTo writes the data to the writer.
func (p SetPlayerInventoryContents) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
type SetPlayerInventory struct {
	...
	Contents SetPlayerInventoryContents
}
...
func (p *SetPlayerInventory) ReadFrom(r io.Reader) (n int64, err error) {
	...
	temp, err = p.Contents.ReadFrom(r)
	n += temp
	if err != nil {
		return n, err
	}
