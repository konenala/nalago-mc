...
// AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp is a sub-structure used in the packet.
type AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp struct {
	// Mapper to string
	Type string
	// Switch 基於 Type：
...
func (p *AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
func (p AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry is a sub-structure used in the packet.
type AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry struct {
	// Mapper to string
	Type string
}
...
// ReadFrom reads the data from the reader.
func (p *AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
// WriteTo writes the data to the writer.
func (p AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// AdvancementsAdvancementMappingEntryValueDisplayDataIcon is a sub-structure used in the packet.
type AdvancementsAdvancementMappingEntryValueDisplayDataIcon struct {
	ItemCount int32 `mc:"VarInt"`
	ItemId int32 `mc:"VarInt"`
	AddedComponentCount int32 `mc:"VarInt"`
	RemovedComponentCount int32 `mc:"VarInt"`
	Components []AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp
	RemoveComponents []AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry
}


// ReadFrom reads the data from the reader.
func (p *AdvancementsAdvancementMappingEntryValueDisplayDataIcon) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
	...
	if p.ItemCount != 0 {
		...
		n += temp
		if err != nil { return n, err }
		p.Components = make([]AdvancementsAdvancementMappingEntryValueDisplayDataIconTemp, componentsCount)
	...
	if p.ItemCount != 0 {
		...
		n += temp
		if err != nil { return n, err }
		p.RemoveComponents = make([]AdvancementsAdvancementMappingEntryValueDisplayDataIconRemoveComponentsEntry, removeComponentsCount)
...
// WriteTo writes the data to the writer.
func (p AdvancementsAdvancementMappingEntryValueDisplayDataIcon) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
type AdvancementsAdvancementMappingEntryValueDisplayData struct {
	...
	Icon AdvancementsAdvancementMappingEntryValueDisplayDataIcon
