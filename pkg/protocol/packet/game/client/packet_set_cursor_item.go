...
// SetCursorItemContentsTemp is a sub-structure used in the packet.
type SetCursorItemContentsTemp struct {
	// Mapper to string
	Type string
	// Switch 基於 Type：
	//   glider -> void
...
func (p *SetCursorItemContentsTemp) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
func (p SetCursorItemContentsTemp) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// SetCursorItemContentsRemoveComponentsEntry is a sub-structure used in the packet.
type SetCursorItemContentsRemoveComponentsEntry struct {
	// Mapper to string
	Type string
}

// ReadFrom reads the data from the reader.
func (p *SetCursorItemContentsRemoveComponentsEntry) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
...
// WriteTo writes the data to the writer.
func (p SetCursorItemContentsRemoveComponentsEntry) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
// SetCursorItemContents is a sub-structure used in the packet.
type SetCursorItemContents struct {
	ItemCount             int32 `mc:"VarInt"`
	ItemId                int32 `mc:"VarInt"`
	AddedComponentCount   int32 `mc:"VarInt"`
	RemovedComponentCount int32 `mc:"VarInt"`
	Components            []SetCursorItemContentsTemp
	RemoveComponents      []SetCursorItemContentsRemoveComponentsEntry
}

// ReadFrom reads the data from the reader.
func (p *SetCursorItemContents) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	_ = temp
	...
	if p.ItemCount != 0 {
		...
		p.Components = make([]SetCursorItemContentsTemp, componentsCount)
	...
	if p.ItemCount != 0 {
		...
		p.RemoveComponents = make([]SetCursorItemContentsRemoveComponentsEntry, removeComponentsCount)
...
// WriteTo writes the data to the writer.
func (p SetCursorItemContents) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	_ = temp
...
type SetCursorItem struct {
	Contents SetCursorItemContents
}
