...
// VehicleMove represents the Serverbound VehicleMove packet.
...
func (*VehicleMove) PacketID() packetid.ServerboundPacketID {
	return packetid.ServerboundVehicleMove
}
...
func init() {
	registerPacket(packetid.ServerboundVehicleMove, func() ServerboundPacket {
		return &VehicleMove{}
	})
}
